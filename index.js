...
var map = AmCharts.makeChart("chartdiv", {
    ...
    dataProvider: {
        ...
        images: [{
            ...
            description:"<style>#test{background-color:pink;margin-left:10px;}</style><div id='test'><h2>Last links reports:</h2><p>Je suis un lezard</p><a href='#'>Je suis la</a></div>"
